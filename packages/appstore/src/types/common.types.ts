...
import type { useStore } from "@deriv/stores"
import type { PlatformIcons } from "Assets/svgs/trading-platform"
import type { RegionAvailability } from "Constants/platform-config"
import type React from "react" // Import JSX
...
// MODIFIED: Removed 'go', 'dxtrade', and 'ctrader' from platform types
export type TPlatform = "mt5" | "trader" | "dbot" | "smarttrader"
...
export type TDetailsOfEachMT5Loginid = DetailsOfEachMT5Loginid & {
  ...
  platform?: TPlatform
  // MODIFIED: Removed 'ctrader' from product types
  product?: "swap_free" | "zero_spread" | "derivx"
...
export type TCFDPlatforms = "Standard" | "Financial" | "CFDs"

export type TStaticAccountProps = {
  name: "Standard" | "Financial" | "CFDs"
  description: string
  is_visible: boolean
  disabled: boolean
  platform: TPlatform
...
export type TTransferAccount = {
  ...
  // MODIFIED: Removed 'dxtrade' and 'ctrader' from account types
  account_type?: "wallet" | "trading" | "mt5" | "binary"
  balance: number
  currency?: string
...
export type TMessageItem =
  | {
      ...
      message: string | React.ReactElement // Use React.ReactElement instead of JSX.Element
    }
  | {
