import { getUrlSmartTrader, getUrlBot, getPlatformSettingsAppstore, routes } from "@deriv/shared"
import { localize } from "@deriv/translations"
import type { PlatformIcons } from "Assets/svgs/trading-platform"
import type { TAccountCategory, TRegionAvailability } from "Types"
...
// MODIFIED: Removed Deriv GO from the platforms list
export const getAppstorePlatforms = (): PlatformConfig[] => [
  ...
  // REMOVED: Deriv GO platform configuration
  // {
...
// MODIFIED: Removed Deriv GO from platform names
